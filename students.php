...
<section class="computerscience">
	...
	<h3 class="titles">Personal Anecdotes</h3>
	...
	<div class="student">
	<h2 class="studentName">Lihui Guo</h2>
	<img class="studentImage" src="images/lihui.png" alt="Lihui">
	<h3 class="studentMajor">Business major</h3>
	<h3 class="titles">Introduction</h3>
